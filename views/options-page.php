<?php $options_nonce = wp_nonce_field( $view['nonce_action'] ); ?>
...
jQuery(document).ready(function($){
    ...
    $('.offlineSiteGenerator__options-save').click(function(e) {
        e.preventDefault();
        ...
        $.ajax({
            ...
            dataType: 'html',
            data: {
                action: 'offlineSiteGenerator_ui_save_options',
                security: '<?php echo $options_nonce; ?>',
                form_data: form_data
            },
...
<div class="wrap">
    <form
        name="offline-site-generator-ui-options"
        method="POST"
    ...
    <p>OfflineSiteGenerator will crawl these WordPress URLs to generate a static site.</p>
    ...
    <button class="button btn-primary offlineSiteGenerator__options-save" type="submit">Save options</button>
