<div class="wrap">
    <form
        name="offline-site-generator-job-options"
        method="POST"
    ...
    <p><i><a href="<?php echo admin_url('admin.php?page=offline-site-generator-jobs'); ?>">Refresh page</a> to see latest status</i><p>
    ...
    <form
        name="offline-site-generator-delete-jobs-queue"
        method="POST"
        action="<?php echo esc_url( admin_url('admin-post.php') ); ?>">

    <?php wp_nonce_field( $view['nonce_action'] ); ?>
    <input name="action" type="hidden" value="offlineSiteGeneratorDeleteJobsQueue" />

    <button class="offline-site-generator-button button btn-danger">Delete all Jobs from Queue</button>
    ...
    <form
        name="offline-site-generator-process-jobs-queue"
        method="POST"
        action="<?php echo esc_url( admin_url('admin-post.php') ); ?>">

    <?php wp_nonce_field( $view['nonce_action'] ); ?>
    <input name="action" type="hidden" value="offlineSiteGeneratorProcessJobsQueue" />

    <button class="offline-site-generator-button button btn-danger">Manually process Job Queue</button>
