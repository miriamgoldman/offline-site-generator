<div class="wrap">
    ...
    <table class="widefat striped">
        ...
        <tbody>
            ...
            <tr>
                ...
                <td>OfflineSiteGenerator will use as much memory as is available to it during processing. Allocating more of your system RAM to PHP should improve performance.</td>
            </tr>
            <tr>
            ...
            <tr>
                ...
                <p>OfflineSiteGenerator now requires a minimum of PHP 7.3 and recommends PHP 7.4 for better performance. If your hosting provider doesn't provide PHP 7.4 or at least PHP 7.3, find a better one!</p>
                </td>
            </tr>
            <tr>
    ...
    <h4>OfflineSiteGenerator Core Options</h4>
