...
/*
    Simple interface to offlineSiteGenerator_core_options DB table
...
class CoreOptions {
     ...
     * @var string
     */
    private static $table_name = 'offlineSiteGenerator_core_options';
    ...
    public static function createTable() : void {
        ...
        \OfflineSiteGenerator\Controller::ensureIndex(
            $table_name,
            'name',
