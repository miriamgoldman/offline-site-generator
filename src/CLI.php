...
class CLI {
    ...
    public function diagnostics() : void {
        WP_CLI::line(
            PHP_EOL . 'OfflineSiteGenerator' . PHP_EOL
        );

        $environmental_info = [
            [
                'key' => 'PLUGIN VERSION',
                'value' => OFFLINESITEGENERATOR_VERSION,
            ],
            [
                'key' => 'PHP_VERSION',
                'value' => phpversion(),
     ...
     * List all options
     *
     *     wp offline-site-generator options list
     *
     * List all options (revealing sensitive values)
     *
     *     wp offline-site-generator options list --reveal_sensitive_values
     *
     * Get option
     *
     *     wp offline-site-generator options get detectPages
     *
     * Set option
     *
     *     wp offline-site-generator options set detectPages 1
     *     wp offline-site-generator options set queueJobOnPostSave 1
     *
     * @param string[] $args CLI args
     * @param string[] $assoc_args CLI args
     */
    ...
    public function offlineSiteGenerator_cli_options_set_detect_common() : void {
    ...
    public function offlineSiteGenerator_cli_options_set_detect_homepage_only() : void {
    ...
    public function offlineSiteGenerator_cli_options_set_detect_maximum() : void {
    ...
    public function process_queue() : void {
        ...
        if ( $job_count === 0 ) {
            ...
            Controller::offlineSiteGeneratorProcessQueue();
