...
class WPCron {
    ...
    public static function setRecurringEvent( int $interval ) : void {
        $next_timestamp = wp_next_scheduled( 'offlineSiteGenerator_process_queue' );
        ...
        if ( $interval === 0 ) {
            ...
            wp_unschedule_event( $next_timestamp, 'offlineSiteGenerator_process_queue' );
            return;
        }
        ...
        $result = wp_schedule_event( time(), $interval, 'offlineSiteGenerator_process_queue' );
     ...
     */
    public static function offlineSiteGenerator_custom_cron_schedules( array $schedules ) : array {
        $schedules['1min'] = [
    ...
    /**
     * Override WP-Cron to use OfflineSiteGenerator's http basic auth creds if set
     *
     * @param mixed[] $cron_request WP-Cron request
     * @return mixed[] WP-Cron request
     */
    public static function offlineSiteGenerator_cron_with_http_basic_auth( array $cron_request ) : array {
