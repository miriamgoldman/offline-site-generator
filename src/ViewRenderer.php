...
class ViewRenderer {
    ...
    public static function renderOptionsPage() : void {
        \OfflineSiteGenerator\CoreOptions::init();

        $view = [];
        $view['nonce_action'] = 'offline-site-generator-ui-options';
        ...
        require_once PLUGIN_PATH . 'views/options-page.php';
    }
    ...
    public static function renderDiagnosticsPage() : void {
        ...
        require_once PLUGIN_PATH . 'views/diagnostics-page.php';
    }

    public static function renderLogsPage() : void {
        $view = [];
        $view['nonce_action'] = 'offline-site-generator-log-page';
        $view['logs'] = WsLog::getAll();

        require_once PLUGIN_PATH . 'views/logs-page.php';
    }

    public static function renderAddonsPage() : void {
        $view = [];
        $view['nonce_action'] = 'offline-site-generator-addons-page';
        $view['addons'] = Addons::getAll();

        require_once PLUGIN_PATH . 'views/addons-page.php';
    }
    ...
    public static function renderCrawlQueue() : void {
        ...
        require_once PLUGIN_PATH . 'views/crawl-queue-page.php';
    }
    ...
    public static function renderCrawlCache() : void {
        ...
        require_once PLUGIN_PATH . 'views/crawl-cache-page.php';
    }
    ...
    public static function renderPostProcessedSitePaths() : void {
        ...
        require_once PLUGIN_PATH . 'views/post-processed-site-paths-page.php';
    }
    ...
    public static function renderStaticSitePaths() : void {
        ...
        require_once PLUGIN_PATH . 'views/static-site-paths-page.php';
    }
    ...
    public static function renderDeployCache() : void {
        ...
        require_once PLUGIN_PATH . 'views/deploy-cache-page.php';
    }

    public static function renderJobsPage() : void {
        $view = [];
        $view['nonce_action'] = 'offline-site-generator-ui-job-options';
        ...
        $view = apply_filters( 'offlineSiteGenerator_render_jobs_page_vars', $view );

        require_once PLUGIN_PATH . 'views/jobs-page.php';
    }

    public static function renderRunPage() : void {
        $view = [];

        require_once PLUGIN_PATH . 'views/run-page.php';
    }
    ...
    public static function renderCachesPage() : void {
        ...
        $exported_site_dir = SiteInfo::getPath( 'uploads' ) . 'offline-site-generator-crawled-site/';
        ...
        // performance check vs map
        $disk_space = 0;
        $processed_site_dir = SiteInfo::getPath( 'uploads' ) . 'offline-site-generator-processed-site/';
        ...
        if ( apply_filters( 'offlineSiteGenerator_deploy_cache_totals_by_namespace', false ) ) {
            $view['deployCacheTotalPathsByNamespace']
                = DeployCache::getTotalsByNamespace();
        }

        $view['uploads_path'] = SiteInfo::getPath( 'uploads' );
        $view['nonce_action'] = 'offline-site-generator-caches-page';

        require_once PLUGIN_PATH . 'views/caches-page.php';
    }
